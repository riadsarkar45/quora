...
const Addvertisements = () => {
    return (
        <div className='ml-4 sticky top-0 h-full w-[18rem] p-4 bg-white border rounded-sm overflow-y-auto'>
            <button className='flex items-center gap-2 bg-gray-100 p-2 rounded-md w-full'>
                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="50" viewBox="0 0 12 12" fill="#616161">
                ...
                <span className='text-[1.3rem]'>Create Space</span>
            </button>
